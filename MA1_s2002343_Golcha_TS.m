...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%While Subtracting the output from the input there is a peak at the end which can 
%be seen, This is due to the falling slope of the window.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
n1=zeros(1,((Nf-1)*HA-L_in));       % number of zeros at end
x=[zeros(1,N),x,n1];
...
y=y(1,N+1:floor((length(y)-Q*((Nf-1)*HA-L_in))));
...
figure(2);
subplot(2,1,1)
%PLotting the Spectogram of Input
MA1_s2002343_Golcha_myspec(x',Fs,N,H,"Input");

subplot(2,1,2)
%PLotting the Spectogram of the Output
MA1_s2002343_Golcha_myspec(y',Fs,N,H,"Output");

%Playing the output file --> uncomment the next line
%soundsc(y,Fs);